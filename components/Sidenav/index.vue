  ...
  >
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto grow h-sidenav basis-full">
      <ul class="flex flex-col pl-0 mb-0 pb-14">
        ...
        <SidenavLink to="/tables" icons="ic:baseline-table-rows" :is-active="route.name === 'tables' ? true : false">
          Table
        </SidenavLink>
        <SidenavLink to="/biling" icons="ic:round-payment" :is-active="route.name === 'biling' ? true : false">
          Biling
        </SidenavLink>
        ...
        <SidenavLink to="profile" icons="ri:user-settings-fill" :is-active="route.name === 'profile' ? true : false">
          Profile
        </SidenavLink>
      </ul>
    </div>
